...
if iRunOnData == True:
    ...
    process.source.fileNames =  ['/store/mc/Summer12_DR53X/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball/GEN-SIM-RECO/PU_S10_START53_V7D-v3/10001/887BBF12-1B67-E211-BF85-002618943969.root'] 
    #process.source.fileNames =  ['file:MC1.root']
...
# Ntuples
process.load('ElectroWeakAnalysis.VPlusJets.ZeeJetsAnalysisPAT_cfi')
